<div>
    <form wire:submit.prevent="update" class="px-4 py-8 flex flex-col gap-4">
        ...
        <flux:field variant="inline">
            <flux:checkbox wire:model.change="isEditPassword" />
            <flux:label>Edit Password</flux:label>
        ...
        <div class="flex flex-col-reverse justify-between gap-2 p-4 sm:flex-row sm:items-center md:justify-end">
