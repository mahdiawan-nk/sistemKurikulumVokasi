<x-layouts.app :title="__('Data Master')">
    <div x-data="{ showSidebar: false }" class="relative flex w-full flex-col md:flex-row">
        ...
        <nav x-cloak
            class="fixed left-0 z-20 flex h-svh w-60 shrink-0 flex-col border-r border-neutral-300 bg-neutral-50 p-4 transition-transform duration-300 md:w-87 md:max-w-xl md:translate-x-0 md:relative dark:border-neutral-700 dark:bg-neutral-900"
